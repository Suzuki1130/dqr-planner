...
- Friends give +3% each up to +30%. The alt-character bonus caps at +30%.
- Total EXP needed = the sum of every level's requirement from your level up to the target, minus the EXP you've already banked in the current level.
- Runs are rounded up.
...
Reborn is a separate community project and its numbers may drift from official DQ. The
"Base EXP per clear" box is editable for exactly that reason — override it with whatever
your own runs show.

Fan project. Not affiliated with Voldex or Roblox.
